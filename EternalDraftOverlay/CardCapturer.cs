...
namespace EternalDraftOverlay
{
    public class CardCapturer
    {
        ...
        private int pixelTestCount = 10;
        private Point startingLocation = new Point(408, 269);
        private int distanceDown = 309;
        private int distanceRight = 219;
        private (int, int) distanceCardArt = (12, -150);
        ...
        public void Capture()
        {
            ...
            if (p != null)
            {
                ...
                bmp.Save(@"../../PerformanceTestData/Print_CollectionCard.bmp");
